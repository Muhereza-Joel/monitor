                        ...
                        <form id="organization-registration-form" class="row g-3 needs-validation" novalidate>
                            <div class="form-group my-2">
                                ...
                                <div class="text-center">
                                    <img id="profile-photo" src="<?php echo e($organisation['logo']); ?>" class="rounded-circle" alt="Profile" width="200px" height="200px" style="border: 3px solid #999; object-fit: cover;">
                                </div>
                                <div class="pt-2">
                                    <input type="hidden" name="image_url" id="image_url" value="<?php echo e($organisation['logo']); ?>">
                            ...
                            <div class="form-group my-2">
                                ...
                                <input type="hidden" name="organisation-id" value="<?php echo e($organisation['id']); ?>">
                                <input value="<?php echo e($organisation['name']); ?>" type="text" class="form-control" name="organization-name" id="organization-name" required>
                            ...
                            <div class="form-group my-2">
                                ...
                                <select name="active" id="" required class="form-control">
                                    ...
                                    <option value="true" <?php echo e($organisation['active'] == 'true' ? 'selected' : ''); ?> >Yes</option>
                                    <option value="false" <?php echo e($organisation['active'] == 'false' ? 'selected' : ''); ?> >No</option>
    ...
    $(document).ready(function() {
        $('#organization-registration-form').submit(function(e) {
            ...
            if (this.checkValidity() === true) {
                ...
                $.ajax({
                    method: 'post',
                    url: '/<?php echo e($appName); ?>/organisations/update/',
                    data: formData,
