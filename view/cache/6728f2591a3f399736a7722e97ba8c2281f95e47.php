          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-xl-10 col-md-10 d-flex flex-column align-items-center justify-content-center">
                ...
                <img src="/<?php echo e($appName); ?>/assets/img/logo_yellow.png" alt="logo" style="width: 400px;">
                <h1><?php echo e($appNameFull); ?></h1>
                <br><br>
              ...
              <div class="row">
                ...
                <div class="col-xl-5">
                  ...
                  <div class="text-center">
                    <img id="profile-photo" src="/<?php echo e($appName); ?>/assets/img/avatar.png" class="rounded-circle" alt="Profile" width="250px" height="250px" style="border: 3px solid #999; object-fit: cover;">
