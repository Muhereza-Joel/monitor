                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="login-form" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-12">
                                    <button id="login-button" class="btn btn-secondary w-100" type="submit"><?php echo e(__('sign_in')); ?></button>

                                </div>
                                <div class="card-footer p-0">
                                    <div class="col-12 text-center">
                                        <p>
                                            <a href="<?php echo e(url('auth/organizations/choose/', null, true)); ?>" class="btn btn-link">Create an account</a> |
                                            <a href="<?php echo e(url('auth/accounts/reset/', null , true)); ?>" class="btn btn-link text-danger ms-2">Forgot Password</a>
