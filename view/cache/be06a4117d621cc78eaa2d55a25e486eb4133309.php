...
<main id="main" class="main">
  <section class="section dashboard">
    ...
    <div class="alert alert-danger p-2">
      <?php echo e($username); ?>, your permissions only allow you to view data. If you need to modify or delete any information, please contact the Administrator to update your permissions.
    </div>
    <?php endif; ?>
...
<script>
  $(document).ready(function() {
    ...
    function fetchEvents(visibility) {
      var url = '/<?php echo e($appName); ?>/events/get-events/';
