                    ...
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-12 col-lg-12 d-flex flex-column align-items-center justify-content-center">
                          ...
                          <img id="profile-photo" src="/<?php echo e($appName); ?>/assets/img/avatar.png" class="rounded-circle" alt="Profile" width="100px" height="100px" style="border: 3px solid #999;">
                          <div class="pt-2">
