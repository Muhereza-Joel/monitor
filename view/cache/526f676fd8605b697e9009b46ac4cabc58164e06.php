        ...
        <div class="card">
          <div class="d-flex  align-items-center  px-3">
            <div class="pagetitle p-2 order-0 w-50">
              <h1 class="py-1">Defense Forces Shop Uganda Ltd Order Payment</h1>
          ...
          <div class="card-body">
            ...
            $amount       =  500;
            $desc         = "Defense Forces Shop Uganda Ltd Order Payments";
            $type         = 'MERCHANT';
            $name         =  $user_data['name'];
            ...
            $callback_url   = 'http://localhost/ShopManagementSystem/dashboard/orders/pay/thankyou/'; //URL user to be redirected to after payment
