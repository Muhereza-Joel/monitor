            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['about']); ?></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['gender']); ?></div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-secondary">Company</div>
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['company']); ?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-secondary">Job</div>
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['job']); ?></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['email']); ?></div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-secondary">Country</div>
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['country']); ?></div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-secondary">District</div>
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['district']); ?></div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-secondary">Village</div>
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['village']); ?></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 text-secondary"><?php echo e($userDetails['phone']); ?></div>
                </div>
