                                        ...
                                        <form action="" id="otp-request-form" class="row g-3 needs-validation" novalidate>
                                            <div class="col-12">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="email" name="email" value="<?php echo e($email); ?>" placeholder="Enter your email address" class="form-control" id="yourEmail" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#otp-request-form').submit(function(e) {
                ...
                $.ajax({
                    method: 'post',
                    url: '/<?php echo e($appName); ?>/auth/accounts/request-otp/',
                    data: formData,
            ...
            $('#otp-verify-form').submit(function(e) {
                ...
                $.ajax({
                    method: 'post',
                    url: '/<?php echo e($appName); ?>/auth/accounts/confirm-password-otp/',
                    data: formData,
                    success: function(response) {
