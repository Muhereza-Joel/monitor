                ...
                <div class="card p-2">
                    ...
                    <div class="card-body">
                        <div class="alert alert-secondary">
                            ...
                            <i class="fw-bold">>>>> <?php echo e($indicator['indicator_title']); ?> indicator <<<<< </i>
                        </div>
                        <form action="" class="needs-validation" novalidate id="edit-response-form">
                            ...
                            <div class="form-group my-2">
                                ...
                                <input required id="progress" value="<?php echo e($response['progress']); ?>" name="progress" readonly type="number" class="form-control">
                                <div class="invalid-feedback">This value is required</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <hr>
                                <div id="notes-editor" style="height: 300px;"><?php echo $response['notes']; ?></div>
                            ...
                            <div class="form-group">
                                ...
                                <hr>
                                <div id="lessons-editor" style="height: 300px;"><?php echo $response['lessons']; ?></div>
                            ...
                            <div class="form-group">
                                ...
                                <hr>
                                <div id="recommendations-editor" style="height: 300px;"><?php echo $response['recommendations']; ?></div>
