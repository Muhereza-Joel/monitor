            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        require_once('../ShopManagementSystem/vendor/pesapal/pesapal/OAuth.php');
                        require_once('../ShopManagementSystem/vendor/pesapal/db/dbconnector.php');
                        require_once('../ShopManagementSystem/vendor/pesapal/pesapal/checkStatus.php');
                        ...
                        <div class="m-4">
                            <h3>Thankyou for paying out your order, transaction is complete</h3>
                            <div class="alert alert-success">Go to the tickets section and print a copy of your receipt..
