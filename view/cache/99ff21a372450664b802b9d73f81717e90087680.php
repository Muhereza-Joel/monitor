    ...
    <div class="d-flex align-items-center">
      ...
      <div style="border-radius: 50%;" class="d-flex align-self-center justify-content-end w-50">
        ...
        <div class="btn-group" role="group" aria-label="Administrator Actions">
          <a data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Add More Responses To This Indicator."  class="btn btn-secondary btn-sm" href="<?php echo e(route('response.add', ['id' => $indicatorId], true)); ?>"><i class="bi bi-plus-circle"></i> Add More Responses</a>
          <a class="btn btn-secondary btn-sm" href="<?php echo e(route('indicator.edit', ['id' => $indicatorId], true)); ?>"><i class="bi bi-pencil px-1"></i>Edit Indicator</a>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="actionDropdown">
                      ...
                      <a href="<?php echo e(route('response.edit', ['id' => $response['id']], true)); ?>" class="dropdown-item">
