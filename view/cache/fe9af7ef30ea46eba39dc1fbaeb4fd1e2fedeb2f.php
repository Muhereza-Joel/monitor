...
<script>
  $(document).ready(function() {
    ...
    $('#delete-branch-form').submit(function(e) {
      ...
      $.ajax({
        method: 'post',
        url: '/<?php echo e($appName); ?>/dashboard/branches/delete/',
        data: formData,
        success: function(response) {
          ...
          setTimeout(function() {
            window.location.replace("/<?php echo e($appName); ?>/dashboard/branches/");
          }, 2000)
        }
      })
    ...
    $('#update-branch-form').submit(function(e) {
      ...
      if (this.checkValidity() === true) {
        ...
        $.ajax({
          method: 'post',
          url: '/<?php echo e($appName); ?>/dashboard/branches/edit/',
          data: formData,
          success: function(response) {
    ...
    $('#create-branch-form').submit(function(e) {
      ...
      if (this.checkValidity() === true) {
        ...
        $.ajax({
          method: 'post',
          url: '/<?php echo e($appName); ?>/dashboard/branches/add/',
          data: formData,
          success: function(response) {
