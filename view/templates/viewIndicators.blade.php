                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="actionDropdown">
                        <a href="{{ route('indicator.responses', ['id' => $indicator['id']], true) }}" class="dropdown-item">
                        ...
                        <a data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Editing an indicator is only available when the indicator is in draft or review state." href="{{ route('indicator.edit', ['id' => $indicator['id']], true)}}" class="dropdown-item">
                        ...
                        <a data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Adding responses to an indicator is only available when the indicator is in draft or review state." href="{{ route('response.add', ['id' => $indicator['id']], true) }}" class="dropdown-item">
                        ...
                        <a href="{{ route('reports.create', ['id' => $indicator['id']], true) }}" class="dropdown-item">
...
<script>
  $(document).ready(function() {
    ...
    $('#confirmMoveToArchiveBtn').on('click', function() {
      var endpointUrl = '/{{$appName}}/dashboard/indicators/move-to-archives/'; // Replace with your actual endpoint URL
