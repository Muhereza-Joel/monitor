                                ...
                                <form id="login-form" class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div class="card-footer p-0">
                                        <div class="col-12 text-center">
                                            <p class="small mt-3">Don't have an account? <a href="/{{$appName}}/auth/register/">Create an account</a></p>
                                            <p class="small">Forgot your password? <a href="/{{$appName}}/auth/accounts/reset/">Reset your account</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
