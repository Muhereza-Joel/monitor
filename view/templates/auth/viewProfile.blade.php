    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="change-profile-pic-form" class="">
          ...
          <img id="profile-photo" src="{{$avator}}" width="100%" height="300px" alt="Profile" style="object-fit: contain;">
          <br><br><br>
...
<script>
  $(document).ready(function() {
    ...
    $('#change-profile-pic-form').submit(function(event) {
      ...
      $.ajax({
        method: "POST",
        url: "/{{$appName}}/auth/user/profile/update-photo/",
        data: formData,
        processData: false,
        contentType: false,
        success: function(response) {
    ...
    $('#currentPassword').on('input', function() {
      ...
      $.ajax({
        url: '/{{$appName}}/auth/check-password/',
        method: 'GET',
        data: {
          password: password
        },
    ...
    $('#edit-profile-form').submit(function(e) {
      ...
      if (this.checkValidity() === true) {
        ...
        $.ajax({
          method: 'post',
          url: '/{{$appName}}/auth/update-profile/',
          data: formData,
          success: function(response) {
    ...
    $('#password-change-form').submit(function(event) {
      ...
      if (newPassword !== renewPassword) {
        ...
        if (this.checkValidity() === true) {
          ...
          $.ajax({
            method: 'post',
            url: '/{{$appName}}/auth/change-password/',
            data: formData,
            success: function(response) {
